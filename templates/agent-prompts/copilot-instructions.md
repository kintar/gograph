...
If you have MCP access to `gograph`, use your native tools (`gograph_query`, `gograph_focus`, `gograph_callers`, `gograph_callees`, `gograph_implementers`, `gograph_source`, `gograph_orphans`).
